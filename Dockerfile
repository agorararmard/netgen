...
ENV NETGEN_ROOT=/netgen_root
ENV BUILD_PATH=/build/

ENV PATH=$NETGEN_ROOT:$NETGEN_ROOT/scripts:$BUILD_PATH/bin:$BUILD_PATH/bin/Linux-x86_64:$BUILD_PATH/pdn/scripts:$PATH
